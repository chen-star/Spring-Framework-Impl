...
public class ControllerTimeCalculatorAspect extends DefaultAspect {
    ...
    public void before(Class<?> targetClass, Method method, Object[] args) throws Throwable {
        log.info("[ControllerTimeCalculatorAspect] Start -- target class: [{}], method: [{}], args: [{}]", targetClass, method, args);
    ...
    public Object afterReturning(Class<?> targetClass, Method method, Object[] args, Object returnValue) throws Throwable {
        ...
        log.info("[ControllerTimeCalculatorAspect] End -- target class: [{}], method: [{}], args: [{}]", targetClass, method, args);
        log.info("[ControllerTimeCalculatorAspect] Time Spent: {}", costTime);
        return returnValue;
    }
}
